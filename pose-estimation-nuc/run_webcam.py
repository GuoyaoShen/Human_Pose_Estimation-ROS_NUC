...
if __name__ == '__main__':
    ...
    while True:
        ...
        # ===new added
        # get joints coords
        list_centers = TfPoseEstimator.caclu_centers(image, humans, imgcopy=False)
        ...
        # get faces
        list_faceboxes = TfPoseEstimator.get_humanfacebox(image, humans, imgcopy=False)
        print('FACES LIST', list_faceboxes)
        scalar_face = 1.0
        tuple_facesz = (128, 128)

        # show face img
        postprocess.show_face_imgs(image_copy, list_faceboxes, tuple_facesz=tuple_facesz, scalar_face=scalar_face)
        # ===new added
